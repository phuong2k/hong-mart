<x-admin-layout>
    ...
    <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            <h1 class="w-full text-3xl text-black pb-6">Sửa sản phẩm</h1>
                ...
                <form method="POST" action="{{ route('admin.product.update', $product->id) }}"
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div class="mb-1">
                            ...
                            <input value="{{ $product->count }}" type="text" id="count" name="count"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="ex: bla bla bla">
                        </div>
                        <div class="mb-1">
                            ...
                            <select
                                ...
                                <option value="0" {{ $product->status == false ? 'selected' : '' }}>Còn hàng
                                </option>
                                <option value="1" {{ $product->status == true ? 'selected' : '' }}>Hết hàng
                                </option>
                            </select>
                        </div>
                        <div class="mb-1">
                            ...
                            <textarea id="description" name="description"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="ex: bla bla bla">{{ $product->description }}</textarea>
                        </div>
                        <div class="mb-2">
                    ...
                    <button type="submit"
                        class="px-4 py-1 text-white font-light tracking-wider bg-blue-600 rounded">Sửa</button>
                </form>
            </div>
        </main>
    </div>
